                ...
                <div className='navbar_sidebar_links_Wrapper'>
                    ...
                    <div className='soultions_dropdown_wrapper'>
                        ...
                        {solutionDropdown && <div className='solution_dropdown5463'>
                            ...
                            <NavLink to={'/solutions/ngage-rhythm'}>NGAGE Rhythm</NavLink>
                            <NavLink to={'/solutions/ngage-play-day'}>NGAGE Play Day</NavLink>
                            <NavLink to={'/solutions/ngage-launchpad'}>NGAGE Launchpad</NavLink>
